...
umap_df[['atrophy', 'hyporeflexia', 'eye_movements', 'incoordination', 'hypertonia', 'hyperreflexia']
        ] = features[['atrophy', 'hyporeflexia', 'eye_movements', 'incoordination', 'hypertonia', 'hyperreflexia']]
...
for i, row in cluster_centroids.iterrows():
    ...
    plt.scatter(x, y, c=cluster_colors[cluster_num - 1],
                label=f'Cluster {cluster_num}', s=400)

    if cluster_num == 1:
        plt.annotate(f'Cluster {cluster_num}', (x, y), xytext=(-30, -60), textcoords='offset points', fontsize=14, fontweight='bold', ha='center', va='center',
                     arrowprops=dict(arrowstyle='->', color='black'))
    elif cluster_num == 2:
        plt.annotate(f'Cluster {cluster_num}', (x, y), xytext=(-75, 10), textcoords='offset points', fontsize=14, fontweight='bold', ha='center', va='center',
                     arrowprops=dict(arrowstyle='->', color='black'))
    else:
...
for i, row in ground_truth_centroids.iterrows():
    ...
    if ground_truth_label == 'CMT':
        plt.annotate('Charcot-Marie-Tooth', (x, y), xytext=(70, 65), textcoords='offset points', fontsize=14, fontweight='bold', ha='center', va='bottom',
                     arrowprops=dict(arrowstyle='->', color='black'))
    elif ground_truth_label == 'HSP':
        plt.annotate('Hereditary Spastic Paraparesis', (x, y), xytext=(-95, 30), textcoords='offset points', fontsize=14, fontweight='bold', ha='center', va='bottom',
                     arrowprops=dict(arrowstyle='->', color='black'))
    else:
...
for i, row in feature_centroids.iterrows():
    ...
    if feature_label == 'atrophy':
        plt.annotate(feature_label, (x, y), xytext=(40, -40), textcoords='offset points', fontsize=12, ha='center', va='center', color='black',
                     arrowprops=dict(arrowstyle='->', color='black'))
    elif feature_label == 'hyporeflexia':
        plt.annotate(feature_label, (x, y), xytext=(40, -40), textcoords='offset points', fontsize=12, ha='center', va='center', color='black',
                     arrowprops=dict(arrowstyle='->', color='black'))
    elif feature_label == 'incoordination':
        plt.annotate(feature_label, (x, y), xytext=(-80, 0), textcoords='offset points', fontsize=12, ha='center', va='center', color='black',
                     arrowprops=dict(arrowstyle='->', color='black'))
    elif feature_label == 'eye_movements':
        plt.annotate(feature_label, (x, y), xytext=(-80, 0), textcoords='offset points', fontsize=12, ha='center', va='center', color='black',
                     arrowprops=dict(arrowstyle='->', color='black'))
    else:
        plt.annotate(feature_label, (x, y), xytext=(-40, 50), textcoords='offset points', fontsize=12, ha='center', va='center', color='black',
                     arrowprops=dict(arrowstyle='->', color='black'))
